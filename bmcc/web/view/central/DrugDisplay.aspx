<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugDisplay.aspx.cs" Inherits="view_central_DrugDisplay" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function findBtn() {
        var p = [];
        FlexGridDrugDisplay.applyQueryReload(p);
        $(".loading").hide();
    ...
    function countstatistics() {
        $.ajax({ type: "POST",
            url: "DrugDisplay.aspx/countstatistics",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
            

                document.getElementById("globinfo").innerHTML = data.d;
            }
        });
...
<body  class ="">
   ...
   <div class="aaa" ; >
    <uc1:dotNetFlexGrid ID="FlexGridDrugDisplay" runat="server" />
    </div>
     <div class="bbb" ; id="nowTime"></div> 

       <div class="ccc"  id="info"><span><label id ="globinfo"  style ="font-size:23px;"/></span></div> 
    </form>
