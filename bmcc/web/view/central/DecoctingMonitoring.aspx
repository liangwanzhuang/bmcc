<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DecoctingMonitoring.aspx.cs" Inherits="view_central_DecoctingMonitoring" %>
...
<body>
    ...
    <label class="yy">煎药机组编号</label>
        <select class="dfinput2" id="unitnum" runat="server" name="" onChange="" style="text-align:center">
