<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineLossiInfor.aspx.cs" Inherits="view_storeroom_MedicineLossiInfor" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //作废
        function deleteMedicineLossiInfor() {
            var rows = FlexGridMedicineLossiInfor.getSelectedRowsIds();
            var strRowIDs = "";
            if (rows.length > 0) {
                strRowIDs = rows[0];
            } else {
            ...
            $.ajax({ type: "POST",
                url: "MedicineLossiInfor.aspx/deleteMedicineLossiInforById",
        ...
        function deleteLossiInforInfo() {
            ...
            if (rows.length > 0) {
                ...
                //alert(rows[i]);
                $.ajax({ type: "POST",
                    url: "MedicineLossiInfor.aspx/deleteLossiInforById",
                    data: "{'strRowIds':\"" + strRowIDs + "\"}",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                        if (data.d == false) {
...
<body>
    ...
    <div class="tools">
        ...
        <asp:Button ID="Button1" runat="server" OnClick="ExportMedicinelossiInfor_Click" Text='导出数据' CssClass="btn3"/>
        </ul>         
   ...
   <ul class="forminfo">
    ...
    <br />  
     ...
     <br />  
     <div >
     <uc1:dotNetFlexGrid ID="FlexGridMedicineLossiInfor" runat="server"  
    ...
    <script language="javascript" type="text/javascript">
        ...
        function addDiv() {
            ...
            var url = "MedicineLossiInforGet.aspx?id=" + rows + "&randomnumber=" + str;
            $("#flowtitle").text("报损信息");
            $("#p_b_body").load(url);
            $("#pop_div").OpenDiv();
        }
        ...
        function UpdateDiv() {
            ...
            var url = "MedicineLossiInforUpdate.aspx?id=" + rows + "&randomnumber=" + str;
