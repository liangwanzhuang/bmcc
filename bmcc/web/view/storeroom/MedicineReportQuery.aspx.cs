...
public partial class view_storeroom_MedicineReportQuery : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, EventArgs e)
        ...
        this.FlexGridReportQuery.InitConfig(
          ...
          // 序号、药品规格、数量、仓库、药方、受理时间等
              ...
              new dotNetFlexGrid.FieldConfig[]{
                ...
                new dotNetFlexGrid.FieldConfig("storageroom","仓库",90,false,dotNetFlexGrid.FieldConfigAlign.Center),
    ...
    public dotNetFlexGrid.DataHandlerResult DotNetFlexGrid1DataHandler(dotNetFlexGrid.DataHandlerParams p)
    {
        ...
        int pageSize = p.rp;
        result.table = rm.finMedicineTransferInfor(Type, STime, ETime);
        
        return result;
    }
    protected void ExportReportQuery_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = hm1.finMedicineTransferInfor(type, sTime, eTime);
        System.DateTime currentTime = new System.DateTime();
        currentTime = System.DateTime.Now;
        string now = currentTime.ToString("yyyyMMdd");
        CreateExcel(dt, "application/ms-excel", "药方报单查询"+now);
    }
