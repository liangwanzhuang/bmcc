<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutboundDataquery.aspx.cs" Inherits="view_storeroom_OutboundDataquery" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript"language="javascript">
       ...
       function deleteStorageListInfo() {
           ...
           $.ajax({ type: "POST",
               url: "OutboundDataquery.aspx/deleteRecipeById",
               data: "{'strRowIds':\"" + strRowIDs + "\"}",
               contentType: "application/json; charset=utf-8",
               success: function (data) {
                   if (data.d == "0") {
   ...
   <div class="formtitle"><span>调拨单列表</span></div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function openDiv() {
            ...
            t = d.getSeconds();
            str += (t > 9 ? "" : "0") + t;
            var url = "outboundqueryUpdate.aspx?id=" + rows + "&randomnumber=" + str;

            $("#flowtitle").text("修改调拨列表信息");
            $("#p_b_body").load(url);
            $("#pop_div").OpenDiv();
        }
        function closeDiv() {
