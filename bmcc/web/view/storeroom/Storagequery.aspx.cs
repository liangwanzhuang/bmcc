...
public partial class view_storeroom_Storagequery : System.Web.UI.Page
{
    ...
    protected void ExportStoreHouse_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = rm.findStorageListInfo(STime, ETime, Warehousing, DrugName);

        System.DateTime currentTime = new System.DateTime();
        currentTime = System.DateTime.Now;
        string now = currentTime.ToString("yyyyMMdd");
        CreateExcel(dt, "application/ms-excel", "入库单信息" + now);
    }
