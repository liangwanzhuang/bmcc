...
public partial class view_storeroom_MedicineWarehouseInvenGet : System.Web.UI.Page
{
    ...
    public static string addWarehouseInvenInfo(string fromid, string drugnum, string InventoryPer, string ActualCapacity, string InventoryStatus, string StorageCondition, string Rmarkes)
    {
        ...
        int sdr = wr.AddMedicineWarehouseInven(fromid, drugnum, InventoryPer, ActualCapacity, InventoryStatus, StorageCondition, Rmarkes);
        if (sdr == 0)
        {
            result = "0";
        }
