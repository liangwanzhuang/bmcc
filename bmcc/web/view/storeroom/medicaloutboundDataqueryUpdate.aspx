<%@ Page Language="C#" AutoEventWireup="true" CodeFile="medicaloutboundDataqueryUpdate.aspx.cs" Inherits="view_storeroom_MedicineStorageUpdate" %>
    ...
    <link href="../../css/style.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         function btnok_onclick() {
             var id = $("#idnum1").val();
             var storageroom1 = $("#storageroom").val();
             ...
             $.ajax({ type: "POST",
                 url: "medicaloutboundDataqueryUpdate.aspx/StorageInfo",
                 data: "{'id':'" + id + "','storageroom':'" + storageroom1 + "','Amount':'" + Amount + "','Rmarkes':'" + Rmarkes + "','ProDate':'" + ProDate + "','ExpiryDate':'" + ExpiryDate + "','Quality':'" + Quality + "','LicenseNum':'" + LicenseNum + "','OSingle':'" + OSingle + "','OSTime':'" + OSTime + "','Warehousing':'" + Warehousing + "'}",
...
<body>
   ...
   <ul class="forminfo">
    ...
    <li><label>仓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库</label>
        <select id="storageroom" runat="Server" class="dfinput2">   
        </select>
       <label>出库人</label><input id ="Warehousing12" runat="Server" name="" type="text" class="dfinput2"/> <i></i> </li>
