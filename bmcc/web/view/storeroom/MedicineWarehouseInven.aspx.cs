...
public partial class view_storeroom_MedicineWarehouseInven : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.FlexGridMWarehouseInven.InitConfig(
            new string[]{
                "title=药房盘点信息",//标题
        ...
        this.FlexGridMWarehouseInven.DataHandler = new dotNetFlexGrid.DataHandlerDelegate(DotNetFlexGrid1DataHandler);
    }  //提供数据的方法
  ...
  */
    ...
    public void CreateExcel(DataTable dt, string FileType, string FileName)
    {
        ...
        string ls_item = "序号\t仓库\t批次\t药品名称\t药品编号\t盘点人\t实际容量\t库存状况\t保管条件\t盘点时间\t盘点日期\t备注\t入库量\t出库量\t报损量\t库存容量\t消耗量\t差值\n";
