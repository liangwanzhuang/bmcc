...
public partial class view_storeroom_InventoryInfor : System.Web.UI.Page
{
    ...
    public dotNetFlexGrid.DataHandlerResult DotNetFlexGrid1DataHandler(dotNetFlexGrid.DataHandlerParams p)
    {
       ...
       // result.table = rm.finInventoryInfor(DrugName, Warehouse);
        ...
        result.table = rm.inventory(DrugName, Warehouse);
...
*/
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = rm.inventory(DrugName1, Warehouse1);
        System.DateTime currentTime = new System.DateTime();
        currentTime = System.DateTime.Now;
        string now = currentTime.ToString("yyyyMMdd");
        CreateExcel(dt, "application/ms-excel", "库房库存信息"+now);
    }
    public void CreateExcel(DataTable dt, string FileType, string FileName)
    {
        ...
        string ls_item = "序号\t 仓库\t 药品批次\t货架号\t 药品名称 \t药品编号\t实际数量 \t 进库量\t 出库量\t报损量 \t 库存容量 \t 差值  \n  ";
