<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineoutboundDataUpdate.aspx.cs" Inherits="view_storeroom_StorageListUpdate" %>
    ...
    <link href="../../css/style.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         function btnok_onclick() {
             ...
             $.ajax({ type: "POST",
                 url: "MedicineoutboundDataUpdate.aspx/StorageListInfo",
