...
public partial class view_storeroom_Outbounddataadd : System.Web.UI.Page
{
    ...
    public static int addtempDrugInfo(string drugnum, string num, string quality, string productdate, string validdate, string permitno, string remark,string fromid)
    {
        ...
        int result = whm.adddtempruginfochange(drugnum, num, quality, productdate, validdate, permitno, remark,fromid);
    ...
    public static string getdruginfobydrugnum(string drugnum,string fromid)
    {
        ...
        SqlDataReader sdr2 = whm.findgrudinfobydrugnumfromstorage(drugnum);
        ...
        int remainingnum = smm.remainingnum(fromid, drugnum);
    ...
    public static string getproductbatchbyid(string fromid)
    {
        ...
        StorageManageModel smm = new StorageManageModel();
        string sr = smm.findproductbatchbyfromid(fromid);
    ...
    {
        StorageManageModel smm = new StorageManageModel();
        string sdr = smm.getdrugname(text,fromid);
    ...
    public static string getproductbatch(string dataname,string fromid)
    {
        ...
        StorageManageModel smm = new StorageManageModel();
        string sdr = smm.getproductbatchbydrugnamekufang(dataname, fromid);
    ...
    public static int ischeckoutnum(string num,string fromid,string drugnum)
    {
        ...
        StorageManageModel smm = new StorageManageModel();
        int result = smm.ischeckoutnum(num, fromid, drugnum);
