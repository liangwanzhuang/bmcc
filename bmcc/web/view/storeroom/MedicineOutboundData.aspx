<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineOutboundData.aspx.cs" Inherits="view_storeroom_MedicineOutboundData" %>
   ...
   <script type="text/javascript"language="javascript">
       ...
       function deleteStorageInfo() {
           ...
           if (rows.length > 0) {
               ...
               //alert(rows[i]);
               $.ajax({ type: "POST",
                   url: "MedicineOutboundData.aspx/deletedrugtoroominfoById",
                   data: "{'strRowIds':\"" + strRowIDs + "\"}",
                   contentType: "application/json; charset=utf-8",
                   success: function (data) {
                       if (data.d == false) {
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function UpdateDiv() {
            ...
            t = d.getSeconds();
            str += (t > 9 ? "" : "0") + t;
            var url = "MedicineoutboundDataUpdate.aspx?id=" + rows + "&randomnumber=" + str;
