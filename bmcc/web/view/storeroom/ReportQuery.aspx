<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportQuery.aspx.cs" Inherits="view_storeroom_ReportQuery" %>
...
<body>
   ...
   <div class="rightinfo">
    ...
    <div class="tools">
        ...
        <input type="Button" ID="Button1"  runat="server" onserverclick="Exportform_Click"   value='导出数据' class="btn3"/>
        </ul>         
