<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WarehouseInvenUpdate.aspx.cs" Inherits="view_storeroom_WarehouseInvenUpdate" %>
     ...
     <script language="javascript" type="text/javascript">
         ...
         function btnok_onclick() {
            ...
            // alert(id);
             ...
             $.ajax({ type: "POST",
                 url: "WarehouseInvenUpdate.aspx/WarehouseInvenUpdateInfo",
