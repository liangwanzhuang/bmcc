<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineStorageManage.aspx.cs" Inherits="view_storeroom_MedicineStorageManage" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript"language="javascript">
        ...
        function deleteStorageInfo() {
            var rows = FlexGridMedicineStorageList.getSelectedRowsIds();
            var strRowIDs = "";
            if (rows.length > 0) {
                strRowIDs = rows[0];
            } else {
        ...
        function deleteStorageListInfo() {
            ...
            $.ajax({ type: "POST",
                url: "MedicineStorageManage.aspx/deleteRecipeById",
                data: "{'strRowIds':\"" + strRowIDs + "\"}",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    if (data.d == "0") {
        ...
        //删除入库药品信息
        function deleteMedicineStorageInfo() {


            var rows = FlexGridMedicineStorage.getSelectedRowsIds();
            var strRowIDs = "";
            if (rows.length > 0) {
                strRowIDs = rows[0];
               ...
               // alert(rows[i]);
                $.ajax({ type: "POST",
                    url: "MedicineStorageManage.aspx/deletedrugtoMedicineroominfoById",
                    data: "{'strRowIds':\"" + strRowIDs + "\"}",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                        if (data.d == false) {
                        ...
                        var p = [];
                        FlexGridMedicineStorage.applyQueryReload(p);
                    }
                });
        ...
        DotNetFlexiGrid_onChecked = function (e) {
            //  alert("onUnChecked" + e);
            FlexGridMedicineStorageList_selectId = e;
            var array = FlexGridMedicineStorageList.getCellDatas(e);
            //    $('#Pspnum').val(array[4]);
        ...
        DotNetFlexiGrid_onunChecked = function (rowId) {
            ...
            FlexGridMedicineStorageList_selectId = rowId;
            var array = FlexGridMedicineStorageList.getCellDatas(0);
        ...
        function drugintoMedicineroom() {
            ...
            if (rows.length > 0) {
                ...
                $.ajax({ type: "POST",
                    url: "MedicineStorageManage.aspx/enterMedicineStorage",
...
<body>
    <form id="form1" runat="server">
     ...
     <%-- 总部分--%> 
         ...
         <div class="rightinfo">
   <div class="formtitle"><span>入库单列表</span></div>
    <div class="tools">
    ...
    <ul class="forminfo">
     ...
     <div style="width:1000px; ">
        <div style="width:45%; float:left">
           <uc1:dotNetFlexGrid ID="FlexGridMedicineStorageList" runat="server" 
    ...
    <script language="javascript" type="text/javascript">
        ...
        function openDiv() {
            ...
            var url = "MedicineStorageUpdate.aspx?id=" + rows + "&randomnumber=" + str;
        ...
        function UpdateDiv() {
            ...
            var url = "MedicineStorageDrugUpdate.aspx?id=" + rows + "&randomnumber=" + str;

            $("#flowtitle").text("修改入库单药品信息");
            $("#p_b_body").load(url);
            $("#pop_div").OpenDiv();
        }
        function closeDiv() {
        ...
        function addDrugDiv() {
            ...
            var url = "MedicineStorageGet.aspx?id=" + rows;
