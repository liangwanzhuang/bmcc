...
public partial class view_storeroom_MedicineStorageDrugUpdate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            ...
            DataTable dt = wr.ftempMedicinedrugtoroomInfo(id);
    ...
    public static string StorageListInfo(int id, string Amount, string Rmarkes, string ProDate, string ExpiryDate, string Quality, string LicenseNum)
    {
        ...
        StorageManageModel wr = new StorageManageModel();
        int result = wr.MedicineStorageDrugInfo(id, Amount, Rmarkes, ProDate, ExpiryDate, Quality, LicenseNum);
