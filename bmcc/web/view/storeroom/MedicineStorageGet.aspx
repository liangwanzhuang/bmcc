<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineStorageGet.aspx.cs" Inherits="view_storeroom_MedicineStorageGet" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function hospitalSelect(select) {
            ...
            if (id != 0) {
                $.ajax({ type: "POST",
                    url: "MedicineStorageGet.aspx/getdruginfobydrugnum",
                    data: "{'drugnum':'" + id + "'}",
        ...
        $(function () {
            ...
            $("#DrugName").focusout(function () {
                ...
                $.ajax({ type: "POST",
                    url: "MedicineStorageGet.aspx/serchDrugInfo",
                    data: "{'text':'" + $(this).val() + "'}",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                        var result = data.d;
        ...
        function ypcDrugInfoClick(dataname) {
            ...
            alert(dataname);
            $.ajax({ type: "POST",
                url: "MedicineStorageGet.aspx/getproductbatch",
        ...
        function btnok_onclick() {
           ...
           // alert(quality);
            ...
            $.ajax({ type: "POST",
                url: "MedicineStorageGet.aspx/addtempDrugInfo",
...
<body>
   ...
   <ul class="forminfo">
    ...
    <li><label>药品名称</label><input id="DrugName" runat="server" name="" type="text" class="dfinput2" />
     <div id="drugnameDiv" style="top:134px;left:80px; position:absolute; background:#B87070;" />
   ...
   <label>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注1</label><input id ="Rmarkes1" runat="Server" name="" type="text" class="dfinput2" readonly="readonly"/></li>
    ...
    <li><label>数量</label><input id="num" runat="server" name="" type="text" class="dfinput2"/>
     <label>质量情况</label> <select id="quality" runat="Server" class="dfinput2">
      ...
      <li> <label>生产日期</label><input id="productdate" runat="Server" name="" type="text" class="dfinput2" onfocus="calendar.show({ id: this });" />
     <label>有效日期</label><input id ="validdate" runat="Server" name="" type="text" class="dfinput2"  onfocus="calendar.show({ id: this });"/></li>
