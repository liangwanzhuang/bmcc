<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Storagequery.aspx.cs" Inherits="view_storeroom_Storagequery" %>
  ...
  <script language="javascript" type="text/javascript" src="../../js/My97DatePicker/WdatePicker.js"></script>
   <script type="text/javascript"language="javascript">
       ...
       function deleteStorageListInfo() {
           ...
           $.ajax({ type: "POST",
               url: "Storagequery.aspx/deleteStorageById",
               data: "{'strRowIds':\"" + strRowIDs + "\"}",
               contentType: "application/json; charset=utf-8",
               success: function (data) {
                   if (data.d == "0") {
       ...
       function drugintoroom() {
           ...
           if (rows.length > 0) {
               ...
               $.ajax({ type: "POST",
                   url: "StorageManage.aspx/enterStorage",
    ...
    <div class="tools">
        ...
        <li class="click" onclick="findStorageListBtn();"><span><img src="../../img/t01.png" /></span>查询</li>
         ...
         <li class="click" onclick="openDiv();"><span><img src="../../img/t02.png" /></span>修改</li>
           ...
           <input type="Button" ID="Button1"  runat="server" onserverclick="ExportStoreHouse_Click"   value='导出数据' class="btn3"/>
        </ul> 
  ...
  <div style="width:1000px; ">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function openDiv() {
            ...
            var url = "StoragequeryUpdate.aspx?id=" + rows + "&randomnumber=" + str;
