...
public partial class view_storeroom_MedicineLossiInfor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {


        this.FlexGridMedicineLossiInfor.InitConfig(
            new string[]{
                "title=药房报损信息",//标题
        ...
        this.FlexGridMedicineLossiInfor.DataHandler = new dotNetFlexGrid.DataHandlerDelegate(DotNetFlexGrid1DataHandler);
    }  //提供数据的方法
    ...
    public static bool deleteLossiInforById(string strRowIds)
    {
        ...
        for (int i = 0; i < strRowsId.Length; i++)
        {
            ...
            a = whm.deletedmedicinelossiInforinfo(strRowsId[i].ToString()); ;
        }
        if (a == 0)
        {
            result = false;
    ...
    protected void ExportMedicinelossiInfor_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = hm1.finMedicineLossiInfor(type);
        System.DateTime currentTime = new System.DateTime();
        currentTime = System.DateTime.Now;
        string now = currentTime.ToString("yyyyMMdd");
        CreateExcel(dt, "application/ms-excel", "药方报损信息"+now);
    }
