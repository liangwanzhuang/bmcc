<%@ Page Language="C#" AutoEventWireup="true" CodeFile="importmatchinglist.aspx.cs" Inherits="view_storeroom_importmatchinglist" %>
...
<body>
   ...
   <li><asp:FileUpload ID="FileUpload1" runat="server" Width="310px" Height="30px" /> </li>
