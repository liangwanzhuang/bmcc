...
public partial class view_storeroom_OutboundDataquery : System.Web.UI.Page
{
    ...
    public static string deleteRecipeById(string strRowIds)
    {
        ...
        for (int i = 0; i < strRowsId.Length; i++)
        {
            ...
            sdr = rm.deleteoutbounddataqueryInfo1(Convert.ToInt16(strRowsId[i]));
        }
        if (sdr == 0)
        {
            result = "0";
    ...
    public void CreateExcel(DataTable dt, string FileType, string FileName)
    {
        ...
        string ls_item = "序号\t仓库\t单号\t开单人\t开单时间\t出库人\t出库时间\n";
