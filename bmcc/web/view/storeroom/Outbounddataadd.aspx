<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Outbounddataadd.aspx.cs" Inherits="view_storeroom_Outbounddataadd" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fromSelectChange(select) {
           ...
           /* $.ajax({ type: "POST",
                url: "Outbounddataadd.aspx/getproductbatchbyid",
                data: "{'fromid':'" + id + "'}",
        ...
        function hospitalSelect(select) {
            ...
            if (id != 0) {
                $.ajax({ type: "POST",
                    url: "Outbounddataadd.aspx/getdruginfobydrugnum",
                    ...
                    success: function (data) {
                        ...
                        $("#num").val(datas[16]);
                        $("#quality").val(datas[19]);
                        $("#productdate").val(datas[17]);
                        $("#validdate").val(datas[18]);
                       $("#permitno").val(datas[20]);
                       $("#remark").val(datas[21]);
        ...
        function fuzzySearch() {
            ...
            if ($("#DrugName").val().length == 0 || $("#DrugName").val().length > 10) {
                ...
                var fromid = $("#fromid").val();
                $.ajax({ type: "POST",
                    url: "Outbounddataadd.aspx/serchDrugInfo",
        ...
        function ypcDrugInfoClick(dataname) {
            ...
            $.ajax({ type: "POST",
                url: "Outbounddataadd.aspx/getproductbatch",
        ...
        function btnok_onclick() {
            ...
            $.ajax({ type: "POST",
                url: "Outbounddataadd.aspx/ischeckoutnum",
                async: false,
                data: "{'num':'" + num + "','fromid':'" + fromid + "','drugnum':'" + drugnum + "'}",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    $("#rnum").val(data.d);
            ...
            $.ajax({ type: "POST",
                url: "Outbounddataadd.aspx/addtempDrugInfo",
                data: "{'drugnum':'" + drugnum + "','num':'" + num + "','quality':'" + quality + "','productdate':'" + productdate + "','validdate':'" + validdate + "','permitno':'" + permitno + "','remark':'" + remark + "','fromid':'" + fromid + "'}",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    if (data.d == 0) {
...
<body>
   ...
   <ul class="forminfo">
     ...
     <input id="rnum" runat="server" name="" type="hidden" class="dfinput2" />
      ...
      <li><label>调出</label><select id="fromid" runat="server" name=""  class="dfinput" onchange="fromSelectChange(this);">
   ...
   <label>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注1</label><input id ="Rmarkes1" runat="Server" name="" type="text" class="dfinput2" readonly="readonly"/></li>
    ...
    <ul class="forminfo">
     <div class="formtitle"><span>出库药品信息添加</span></div>
    
   

    <li><label>数量(调出)</label><input id="num" runat="server" name="" type="text" class="dfinput2"/>
     <label>质量情况</label> <select id="quality" runat="Server" class="dfinput2" readonly="readonly">
