<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WarehouseInvenGet.aspx.cs" Inherits="view_storeroom_WarehouseInvenGet" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
            ...
            if (id != 0) {
                $.ajax({ type: "POST",
                    ...
                    success: function (data) {
                       ...
                       // $("#num").val(datas[16]);
                        // $("#quality").val(datas[20]);
                        // $("#productdate").val(datas[18]);
                        //$("#validdate").val(datas[19]);
                        // $("#permitno").val(datas[21]);
                        //  $("#remark").val(datas[17]);
        ...
        function btnok_onclick() {
            ...
            $.ajax({ type: "POST",
                url: "WarehouseInvenGet.aspx/addWarehouseInvenInfo",
