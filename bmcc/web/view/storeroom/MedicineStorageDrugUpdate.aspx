<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicineStorageDrugUpdate.aspx.cs" Inherits="view_storeroom_MedicineStorageDrugUpdate" %>
    ...
    <link href="../../css/style.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         function btnok_onclick() {
             ...
             $.ajax({ type: "POST",
                 url: "MedicineStorageDrugUpdate.aspx/StorageListInfo",
