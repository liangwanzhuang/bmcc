<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outboundqueryUpdate.aspx.cs" Inherits="view_storeroom_MedicineStorageUpdate" %>
    ...
    <link href="../../css/style.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         function btnok_onclick() {
             ...
             $.ajax({ type: "POST",
                 url: "outboundqueryUpdate.aspx/StorageInfo",
