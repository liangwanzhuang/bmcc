<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MeRoomUpdate.aspx.cs" Inherits="view_system_MeRoomUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btnok_onclick() {
            ...
            $.ajax({ type: "POST",
                url: "MeRoomUpdate.aspx/updateDeliveryInfo",
                data: "{'id':'" + id + "','meRoomName':'" + meRoomName + "','meRoomNum':'" + meRoomNum + "','Remarks':'" + Remarks + "'}",
                // "','SendTime':'" + SendTime +
