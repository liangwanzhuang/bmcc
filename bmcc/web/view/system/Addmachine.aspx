<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addmachine.aspx.cs" Inherits="view_system_Addmachine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btnok_onclick() {
            ...
            $.ajax({ type: "POST",
                url: "Addmachine.aspx/addMachineinfo",
                data: "{'meRoomName':'" + meRoomName + "','unitnum':'" + unitnum + "','machinenum':'" + machinenum + "','macaddresss':'" + macaddresss + "','typeofmachine':'" + typeofmachine + "','status':'" + status + "','openstatus':'" + openstatus + "','healthystatus':'" + healthystatus + "','disinfectionstatus':'" + disinfectionstatus + "','checkman':'" + checkman + "','checktime':'" + checktime + "','equipmenttype':'" + equipmenttype + "'}",
                // "','SendTime':'" + SendTime +
                ...
                success: function (data) {
                    ...
                    if (data.d == "1") {
                        ...
                        alert('添加失败，一个机组只能有一台包装机或者机器名称已存在');
...
<body>
   ...
   <div class="formbody">
     ...
     <div class="formtitle"><span>机器信息</span></div>
