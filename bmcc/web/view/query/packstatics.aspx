<%@ Page Language="C#" AutoEventWireup="true" CodeFile="packstatics.aspx.cs" Inherits="view_query_packstatics" %>
	...
	<script src="../../chart/serial.js" type="text/javascript"></script>
     ...
     <script type="text/javascript">
         ...
         function findBtn() {
             ...
             var p = [{ name: "packnum", value: packnum.val() }, { name: "StartTime", value: StartTime.val() }, { name: "EndTime", value: EndTime.val()}];

             FlexGrid3.applyQueryReload(p);
...
<body>
    ...
    <div class="rightinfo">
     ...
     <li>
     <label>包装机号</label>
      <select id="packnum" runat="server" class="dfinput2" name="" onchange="" style="text-align:center">
    ...
    <li> <uc1:dotNetFlexGrid ID="FlexGrid3" runat="server" /> </li>
