<%@ Page Language="C#" AutoEventWireup="true" CodeFile="excelimport.aspx.cs" Inherits="view_recipe_excelimport" %>
...
<body>
   ...
   <li ><asp:FileUpload ID="FileUpload1" runat="server" Width="400px" Height="40px"   style="text-align:center; font-size:15px;"/> </li>
